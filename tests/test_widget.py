...
@pytest.fixture
def date_type():
    return ["12024-03-11T02:26:18.671407", "2024-50-11T02:26:18.671407", "2024-03-50T02:26:18.671407", ""]


def test_get_date_type(date_type):
...
def test_date_day_in_month(date_day_in_month):
...
def test_mask_account_card_standard(account_card, expected):
...
def test_mask_account_cards(account_card, expected):
